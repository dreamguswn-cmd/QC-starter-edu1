...
export const fallbackProjects = [
  ...
  { id: 'p4', sort_order: 4, title: 'VOC Improve × AWS 결과관리·운영감사 QA', subtitle: 'pytest 89건, 실제 LLM Judge 70건과 S3·CloudTrail 검증을 연결한 최종 팀 프로젝트', role: '팀 프로젝트 · 4팀', stack: 'pytest · LLM Judge · AWS CLI · S3 · CloudTrail', image: 'assets/voc-final-cover.png', href: 'downloads/VOC_Presentation_v1.8.pptx' },
